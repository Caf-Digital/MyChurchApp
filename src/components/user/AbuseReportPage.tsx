      ...
      <div className="max-w-md mx-auto p-4 text-center pt-20">
        ...
        <div className="p-4 bg-yellow-50 rounded-xl mb-6">
          <p className="text-sm text-yellow-700">
            ...
            Si vous êtes en danger immédiat, appelez la <strong>Police (112 / 113)</strong> ou contactez votre pasteur de confiance.
          </p>
        </div>
    ...
    <div className="max-w-2xl mx-auto p-4 pb-24">
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-xl">
        ...
        <div className="space-y-2 text-sm">
          <a href="tel:112" className="flex items-center gap-2 text-[#cc9b00]">
            <Phone className="h-4 w-4" />
            112 / 113 - Police nationale (RDC)
          </a>
          <a href="tel:+243818906366" className="flex items-center gap-2 text-[#cc9b00]">
            <Phone className="h-4 w-4" />
            UNICEF RDC - Protection de l'enfance
          </a>
          <a href="tel:+243817106710" className="flex items-center gap-2 text-[#cc9b00]">
            <Phone className="h-4 w-4" />
            Ligne verte - Violences basées sur le genre
          </a>
          <a href="https://www.monusco.unmissions.org" target="_blank" rel="noopener" className="flex items-center gap-2 text-[#cc9b00]">
            <ExternalLink className="h-4 w-4" />
            MONUSCO - Nations Unies en RDC
          </a>
        </div>
      </div>
    </div>
